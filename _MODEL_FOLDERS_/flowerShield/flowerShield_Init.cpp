...
*/   //---------------------        
      filePathName = [[NSBundle mainBundle] pathForResource:@"flowerShield_DOT3_20p" ofType:@"png"];                                                  
      image        = imgLoadImage([filePathName cStringUsingEncoding:NSASCIIStringEncoding]);                                                   
      ...
      loadTexture("_MODEL_FOLDERS_/flowerShield/flowerShield_DOT3_20p.png",          flowerShield_NORMALMAP);                                                      
